...
// ---- plan pricing (cents) â keep in sync with the setup fee in the checkout fn ----
...
// Founder SMS alert (see step 5 above) â same phone/from used by lead-intake.js.
...
// 5) founder SMS alert â GHL has no API to link a new sub-account's number to
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 0) IDEMPOTENCY â this checkout charges the setup fee (payment mode); each order
